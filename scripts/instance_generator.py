...
def write_test_to_file(path, number_of_machines, jobs):
    ...
    '''
    content = str(number_of_machines) + " 100\n"
    for job in jobs:
        content += str(job) + " "
...
def hetereogenea():
    jobs = [];
    #gerar 10 tarefas com tam. no intervalo [100,150]
    for i in range(1,11):
        jobs.append(random.randint(100, 150))

    #gerar 90 tarefas com tam. no intervalo [10,50]
    for i in range(1,91):
        jobs.append(random.randint(10, 50))
    #print(jobs)
    return jobs

def homogenea():
    jobs = [];
    #gerar 100 tarefas com tam. no intervalo [10,50]
    for i in range(1,101):
        jobs.append(random.randint(10, 50))
    #print(jobs)
    return jobs

file_path = "./../instancias/teste/homogenea/"
for i in range(1,101):
    write_test_to_file(file_path+str(i), 10, knuth_shuffle(homogenea()))

file_path = "./../instancias/teste/hetereogenea/"
for i in range(1,101):
